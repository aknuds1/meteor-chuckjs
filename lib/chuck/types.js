(function() {
  ...
  define("chuck/types", ["chuck/audioContextService", "chuck/namespace", "chuck/logging"], function(audioContextService, namespace, logging) {
    var ChuckFunctionBase, ChuckMethod, ChuckStaticMethod, ChuckType, FuncArg, FunctionOverload, OscData, TwoPi, adsrNamespace, arrayNamespace, constructAdsr, constructDac, constructEnvelope, constructObject, constructOsc, constructStep, module, oscNamespace, shredNamespace, stepNamespace, tickAdsr, tickSinOsc, tickStep, types, ugenNamespace;
    module = {};
    TwoPi = Math.PI * 2;
