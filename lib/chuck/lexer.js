    ...
    Lexer = (function() {
      ...
      Lexer.prototype.tokenize = function(code) {
        ...
        while (this.chunk = code.slice(i)) {
          consumed = this.floatToken() || this.intToken() || this.commentToken() || this._matchToken() || this.identifierToken() || this.whitespaceToken() || this.stringToken() || this.literalToken();
