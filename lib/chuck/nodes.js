(function() {
  ...
  define("chuck/nodes", ["chuck/types", "chuck/logging", "chuck/audioContextService"], function(typesModule, logging, audioContextService) {
    var AdditiveSubtractiveOperatorBase, DivideOperator, ExpressionBase, ExpressionList, GtLtOperatorBase, NodeBase, ParentNodeBase, PlusPlusOperatorBase, TimesDivideOperatorBase, TimesOperator, module, types;
    module = {};
